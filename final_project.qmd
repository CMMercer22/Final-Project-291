...
#Just a bit confused here so will review it later
We began to test our model using stepwise AIC. We started with a full model that had all the variable and used the stepwise AIC forward method. We can see the AIC dropped as we go.
