...
## Interpret the hypothesis test and its' results - done 

The full model contains 5 predictor terms and the reduced model contains 3 predictor terms. We want to see if the additional 2 predictor (number of students & percent economically disadvantaged in each school) terms contribute meaningfully to the model. 

$$
H_0:\ \beta_j = 0 \quad \text{for all p predictor terms being dropped from the full model } 
$$
$$
H_A:\ \beta_j \neq 0 \quad \text{for atleast one of the p predictor terms being dropped from the full model } 
$$
We can conduct this nested F tests using anova. 


```f3175f2a-e8a0-4436-be12-b33925b6d220
31b8e172-b470-440e-83d8-e6b185028602::31b8e172-b470-440e-83d8-e6b185028602
```

We reject the null hypothesis and conclude that we have very strong evidence that atleast one of the extra terms is necessary (p \< 0.05) taking the significance level 0.05.
